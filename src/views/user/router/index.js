export default [
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "campaign" */ "@/views/user/CampaignDetails.vue"
      ),
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "discoverDetails" */ "@/views/user/DiscoverDetailDeleivery.vue"
      ),
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "subscription" */ "@/views/user/Subscription.vue"
      ),
  },
  {
    path: "notifications",
    ...
    component: () =>
      import(
        /* webpackChunkName: "notifications" */ "@/views/user/Notifications.vue"
      ),
  },
  {
    path: "edit-profile",
    ...
    component: () =>
      import(
        /* webpackChunkName: "editProfile" */ "@/views/user/EditProfile.vue"
      ),
  },
  {
    path: "offer/:id/:name",
