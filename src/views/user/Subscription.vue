				...
				<div class="pageHead">
					<div class="d-flex align-items-center">
						<div class="pageHead__icon">
							<img v-lazy="`${$config.IMG_HOST}/50x50/${campaign.logo}`" alt="" class="img-fluid" />
						</div>
						<h1>{{ campaign.name }}</h1>
					</div>
...
export default {
	...
	components: {
		DeleiveryImages: () =>
			import(/* webpackChunkName: "deleiveryImages.chunk" */ '@/components/user/campaign/DeleiveryImages.vue'),
	},
	created() {
