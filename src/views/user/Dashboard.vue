      ...
      <div class="col-md-5 col-lg-4">
        ...
        <div class="dashboard__statistic">
          <div class="dashboard__statistic--counter">
            <base-progress-circle :progress="complete" color="#9637F1" />
            Completion
          </div>
          <div class="dashboard__statistic--counter">
            <base-progress-circle :progress="response" color="#57B894" />
            Respone Rate
          </div>
          <div class="dashboard__statistic--counter">
            <base-progress-circle :progress="onTime" color="#F70101" />
            Job Ontime
          </div>
        </div>
      </div>
      <div class="col-md-7 col-lg-8">
        <div>
          <b-tabs content-class="mt-3">
            ...
            <b-tab title="Revision"><p>I'm the second tab</p></b-tab>
...
export default {
  ...
  components: { DiscoverCard, BaseProgressCircle, ProfileCard },
};
</script>
