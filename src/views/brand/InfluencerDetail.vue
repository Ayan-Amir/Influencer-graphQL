<template>
	<div>
			...
			<div class="influencerDetail">
				...
				<div class="influencerDetail__right">
					...
					<p>
						...
						vlogger, composer, dancer and singer. He became known in
						2011, with his appearance in the series Bet with life with
						his colleagues from Lala Band, where he played Andrei
						Anghel, a series that received the award for “best debut” at
						the VIP Awards Gala.
					</p>
					<div class="influencerDetail__right--btnWrapper">
						<h2>Price: 1.000 RON</h2>
						<div class="inline-btns onDesktop">
							<a href="#" class="btn btn-primary" v-b-modal.introduction>Buy</a>
		...
		<b-modal ref="introduction" id="introduction" centered>
			...
			<p class="subTitle">
				What do you want the local Influencers to include in their
				posts?
			</p>
			<form>
				...
				<div class="form-group">
					<label class="control-label"
						>Instructions and campaign details for influencers:
					</label>
					<textarea
						class="form-control"
				...
				<button type="button" class="btn btn-primary" @click="hideModal" v-b-modal.paymentMethod>continue</button>
			</form>
		</b-modal>
		<!-- modal End-->
		...
		<b-modal ref="paymentMethod" id="paymentMethod" centered>
			...
			<form>
				...
				<button type="button" class="btn btn-primary" v-b-modal.invoicingDetail @click="hideModal2">Conﬁrm Payment</button>
			</form>
		</b-modal>
		<!-- modal End-->
