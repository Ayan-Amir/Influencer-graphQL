			...
			<div class="influencerDetail">
				<div class="influencerDetail__left">
					<div class="influencerDetail__left--image onDesktop">
						<img src="@/assets/images/iPhone-12.png" alt="" class="img-fluid" />
					</div>
					<!-- hide on Desktop -->
				...
				<div class="influencerDetail__right">
					...
					<div class="row">
						<div class="col-6 col-xl-3" v-for="item in socialMedia" :key="item.id">
					...
					<p>
						Dorian Hâtz Popa August 7, 1988, Constanța, Romanian vlogger, composer, dancer and singer. He
						became known in 2011, with his appearance in the series Bet with life with his colleagues from
						Lala Band, where he played Andrei Anghel, a series that received the award for “best debut” at
						the VIP Awards Gala.
					</p>
					...
					<h2 class="onMobile">Recent Campaigns</h2>
					<div class="d-flex align-items-center mt-3">
						<div class="influencerDetail__right--icon">
							<img src="@/assets/images/icons/avatar.png" alt="" class="img-fluid" />
						</div>
