      ...
      <div class="topHead">
        ...
        <div class="topHead__left">
          <ul class="mainLinks">
            ...
            <li>
              <router-link to="" v-b-modal.createOffer
                >Create Free Offer</router-link
              >
            </li>
          </ul>
          <base-filters
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <a
            ...
            @click="hideModal('createOffer')"
            v-b-modal.freeService
            >Free Service</a
          >
    ...
    <b-modal ref="freeService" id="freeService" centered>
      ...
      <form>
        ...
        <button type="button" class="btn btn-default full">
          Add an image for the offered product
        </button>
        ...
        <ul class="checkbox list-unstyled">
          ...
          <li>
            <label>
              <input type="checkbox" name="location" />
              <span
                >No, I will chech an approve personally every influencer</span
              >
            </label>
          </li>
        </ul>
...
/deep/ {
  .quantityToggle {
    ...
    button {
      ...
      &.decrement {
        &:before {
          background: url(../../assets/images/icons/minus.png) center center
            no-repeat;
          width: 11px;
          height: 4px;
        }
      ...
      &.increament {
        &:before {
          background: url(../../assets/images/icons/pluss.png) center center
            no-repeat;
          width: 10px;
          height: 17px;
        }
