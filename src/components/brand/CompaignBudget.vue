		...
		<template v-if="this.loaded">
			<div class="contentBox">
				...
				<div class="contentBox__body">
					...
					<p class="contentBox__body--subTitle">{{ campaignEstimate.reach }} Estimated reach</p>
					...
					<!-- Rang slider -->
					<base-slider :min="0" :max="1000" :input="newCampaignFilters.influencers" @value="selectedValue" />
					<!-- Rang slider -->
					<div class="d-flex align-items-center justify-content-between mb-15">
						<p class="heading m-0">Posts</p>
						<span class="range"> {{ newCampaignFilters.posts }} </span>
					</div>

					<!-- Rang slider -->
					<base-slider :min="0" :max="100" :input="newCampaignFilters.posts" @value="selectedpost" />
					<!-- Rang slider -->
